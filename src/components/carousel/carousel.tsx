  ...
  const carouselItems = [
    {
      ...
      description: `Dive into the fascinating realm of artificial intelligence - the cutting-edge technology that mimics human intelligence. Discover its applications in various fields and how it's shaping the future.`,
      imageSrc: Image1,
      ...
      {carouselItems.map((item, index) => (
        <SwiperSlide key={index} style={{ position: 'relative' }}>
          ...
          <div className="position-absolute top-50 start-50 translate-middle text-center text-white">
            ...
            <a href={item.buttonLink} className="btn button-text">
              Click Here
            </a>
          </div>
        </SwiperSlide>
